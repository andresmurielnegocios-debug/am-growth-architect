  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-6 h-auto md:h-20 flex flex-col md:flex-row items-center justify-between gap-3 py-3 md:py-0">
        <motion.a
          href="#inicio"
          className={`font-display font-extrabold tracking-tightest whitespace-nowrap text-base md:text-lg ${textColor}`}
...
const services = [
  ...
  { icon: Video, name: "Authority Video™", sub: "Video estratégico profesional para redes sociales.", price: "$430.000 COP", priceUsd: "USD $126", features: ["Guion estratégico", "Estructura de embudo", "Grabación & edición pro", "Copy persuasivo"] },
  { icon: Edit3, name: "Edición de video básico", sub: "Edición profesional para redes sociales", price: "$200.000 COP", priceUsd: "USD $44", features: ["Audio + música libre", "Subtítulos", "Cortes dinámicos", "Formato adaptable"] },
