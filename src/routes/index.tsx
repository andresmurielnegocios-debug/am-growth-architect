...
const services = [
  ...
  { icon: Video, name: "Authority Video™", sub: "Video de alto impacto para redes sociales.", price: "Desde $300.000 COP", priceUsd: "USD $126", features: ["Guion estratégico", "Estructura de embudo", "Grabación & edición pro", "Copy persuasivo"] },
